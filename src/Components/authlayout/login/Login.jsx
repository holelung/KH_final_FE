    ...
    <>
      ...
      <div className="flex flex-col items-center gap-10">
        ...
        <section className="flex flex-col items-center gap-6 font-EliceDigitalBaeumB select-none">
          <div className="text-5xl text-slate-500">Login</div>
          <div className="text-3xl text-slate-400">Welcome!</div>
        </section>
        {/* 플렉스 아이템 2-2: 로그인 값 입력 폼 */}
        <form onSubmit={(e) => handleSubmitLogin(e)} className="flex flex-col items-center gap-6 font-SebangGothicB text-xl">
          {/* 사번 입력 */}
          <input
            id="username"
            type="text"
