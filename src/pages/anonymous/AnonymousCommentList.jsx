...
// 익명 댓글 리스트 컴포넌트
function AnonymousCommentList({ boardId }) {
          ...
          <li key={c.id} style={{ borderBottom: "1px solid #ddd", padding: "10px 0" }}>
            ...
            {editingId === c.id ? (
              <>
                ...
                <button onClick={() => setEditingId(null)} style={{ marginLeft: "6px" }}>
                  취소
                </button>
              </>
            ) : (
              <>
                ...
                {c.userId === myUserId && (
                  <div>
                    ...
                    <button onClick={() => handleDelete(c.id)} style={{ marginLeft: "6px", color: "red" }}>
                      삭제
                    </button>
                  </div>
                )}
...
export default AnonymousCommentList;
